...
namespace Lljxww.Common.Test
{
    ...
    public class ApiResultConvertUnitTest
    {
        ...
        {
            [DataMember]
            public int RightTypes { get; set; }

            [DataMember]
            public bool IsShowFeePage { get; set; }

            [DataMember]
            public int SelfError { get; set; }

            [DataMember]
            public int ParentError { get; set; }
            ...
            [DataMember]
            public IList<CardRightsModel> CardRights { get; set; }

            [DataMember]
            public IList<FeeRightsModel> FeeRights { get; set; }

            [DataMember]
            public FileAuthModel FileAuthModel { get; set; }
        }
            ...
            public IList<string> Fields { get; set; } = new List<string>
        {
            ...
            /// </summary>
            [DataMember]
            public Dictionary<string, string> FieldValuePairs { get; set; } = new Dictionary<string, string>();
        }
        ...
        {
            [DataMember]
            public RightUserBaseModel RightUserBase { get; set; }
            ...
            [DataMember]
            public int PurchasedPage { get; set; }
        }
